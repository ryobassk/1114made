...
#出力パス（csv）
path_csv = './result/1gakkai_result512.csv'
...
for i in range(len(makeimg_num)):
    ...
    for k in range(0,705): #0,513     256,513
        TM_maxScore = [0]*20
        template = makeimg_num[i][0 : 128, k : k+64]#(128,256)
    ...
    path_plt = './result/1gakkai_result512_' + str(i)+ '.jpg'
    # グラフの描画先の準備
    fig = plt.figure()
    # ここにグラフを描画する処理を記述する
